...
def save_price_to_db(user_id: str, url: str, store: str, price: Decimal | None, name: str | None = None, *, desired_price: Decimal | None = None, notification_platform: str | None = None):
    ...
    try:
        ...
        if existing_record:
            ...
            VALUES ({', '.join(all_placeholders)}, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP + INTERVAL '1 hour', CURRENT_TIMESTAMP)
            RETURNING id
            """
